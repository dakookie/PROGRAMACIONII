...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("ID_LOCPADRE\t");
        System.out.print("ID_LOCTIPO\t\t");
        ...
        try {
            ...
            for (Localidad p : pais.getAllPais()) {
                ...
                //System.out.print(p.getOBSERVACION() + "\t\t");
                //System.out.print(p.getFECHA_CREACION() + "\t\t");
                //System.out.print(p.getFECHA_MODIFICA() + "\t\t");
